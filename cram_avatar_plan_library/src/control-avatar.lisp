...
(defun init-ros-avatar (name)
  ...
  ;;(setf *csl-command-srv* (concatenate 'string "/" name *csl-command-srv*))
  ;;(let(( *csl-command-srv* (concatenate 'string "/" name *csl-command-srv*))))
  
  (setf *csl-command-srv* "/send_console_command")
  (setf *csl-command-srv* (concatenate 'string "/" name *csl-command-srv*))
