...
(defvar *location* (make-3d-vector -313 -25 81) " location for placing the plate")
(defvar *object*)
(setq *object* (desig:an object (type bowl) (name "SM_Object")))
...
(defun release (&key ((:from-hand ?from-hand)) &allow-other-keys)
